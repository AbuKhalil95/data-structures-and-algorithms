...
const fixTheTypo = () => $('li:nth-of-type(3)').html('Pear');
...
const findHappiness = (arr) => arr.reduce((acc,element) => {
...
const standardizePhoneNumbers = (arr) => arr.map(element => {
  let str = '';
  str = element.substring(1,4) + element.substring(6,9) + element.substring(10,15);
  return str;
});
/* ------------------------------------------------------------------------------------------------
